...
/// @nodoc
mixin _$SearchState {
  List<SearchResultData> get searchResultLis =>
      throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<SearchResultData> searchResultLis,
...
class _$SearchStateCopyWithImpl<$Res, $Val extends SearchState>
  ...
  @override
  $Res call({
    Object? searchResultLis = null,
    Object? idleList = null,
    Object? isLoading = null,
    Object? isError = null,
  }) {
    return _then(_value.copyWith(
      searchResultLis: null == searchResultLis
          ? _value.searchResultLis
          : searchResultLis // ignore: cast_nullable_to_non_nullable
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      {required final List<SearchResultData> searchResultLis,
      required final List<Downloads> idleList,
      required this.isLoading,
      required this.isError})
      : _searchResultLis = searchResultLis,
        _idleList = idleList;

  final List<SearchResultData> _searchResultLis;
  @override
  List<SearchResultData> get searchResultLis {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_searchResultLis);
  }
  ...
  @override
  String toString() {
    return 'SearchState(searchResultLis: $searchResultLis, idleList: $idleList, isLoading: $isLoading, isError: $isError)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._searchResultLis, _searchResultLis) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_searchResultLis),
